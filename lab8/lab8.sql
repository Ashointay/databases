...
-- Yes, it created B-tree index automatically
...
-- Without the index, it would scan the whole table to check each name
...
-- Summary Questions
-- 1. B-tree
-- 2. WHERE, JOIN, ORDER BY
-- 3. On small tables or on columns with frequent INSERT/UPDATE/DELETE operations.
-- 4. Indexes get updated and writes slow down
-- 5. Use EXPLAIN